  ...
  return (
    <div className="flex h-16  sticky top-0 z-10 bg-white bg-opacity-30 backdrop-blur-lg  ">
      ...
      h-16 bg-violet-700 rounded-full w-40  text-white   px-8 absolute -left-12 ">
          {/* <MyClassLogoWhite /> */}
          <span className='text-xl font-bold font-sans min-w-4'>{data?.user?.name}</span>
      </Link>

      <div className="flex grow justify-evenluy self-center mx-2 gap-2 absolute left-28 z-30">
        <NavLinks />
      </div>
