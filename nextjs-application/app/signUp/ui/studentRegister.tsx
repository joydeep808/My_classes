...
export default function StudentRegisterForm(){
    ...
    useEffect(()=>{
        if (errorMessage){
            ...
            if (errorMessage.split('!')[0] === "OTP send to you email "){
    ...
    return(
        <form action={dispatch} className="flex gap-1  self-center p-6 flex-col w-full max-w-[600px]  mx-2"  >
            <strong className="  text-4xl font-semibold my-3 z-10">We welcome you as a student</strong >
            ...
            <div className="mt-4 relative">
                ...
                <input className="peer block w-full rounded-full border-0 bg-gray-200 
                    ...
                    id="class"  type="number" name="class"
                    placeholder="Enter class you are in" required
