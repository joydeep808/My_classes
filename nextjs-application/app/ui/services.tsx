...
//               <Link key={item.name} href={item.href} className=' hover:shadow-2xl relative flex flex-col shadow-lg rounded-3xl h-auto transition-all ease-linear items-center p-1 hover:scale-105 bg-white overflow-hidden' >
